...
public class HomePage {
    ...
    public void CategoryWomen(WebDriver driver, String women, String tshirts) throws InterruptedException {
        Actions builder = new Actions(driver);
        ...
        element3.click();
        Thread.sleep(1000);
        WebElement element4 = driver.findElement(By.xpath("//*[@id='block_top_menu']/ul/li[1]/ul/li[1]/ul/li[1]/a[contains(text(), '"+ tshirts +"')]"));
